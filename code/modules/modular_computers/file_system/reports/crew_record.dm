...
FIELD_LONG("General Notes (Public)", public_record, null, access_heads, TRUE)
...
// EMPLOYMENT RECORDS
FIELD_LONG("Employment Record", employment_record, access_heads, access_heads, TRUE)
FIELD_SHORT("Home System", homeSystem, access_heads, access_change_ids, FALSE, TRUE)
FIELD_SHORT("Faction", faction, access_heads, access_heads, FALSE, TRUE)
FIELD_LONG("Qualifications", skillset, access_heads, access_heads, TRUE)
