...
/obj/machinery/door/airlock/sandstone
	...
	matter = /decl/material/solid/stone/sandstone
...
/obj/machinery/door/airlock/gold
	...
	matter = /decl/material/solid/metal/gold

/obj/machinery/door/airlock/silver
	name = "Silver Airlock"
	icon = 'icons/obj/doors/Doorsilver.dmi'
	matter = /decl/material/solid/metal/silver

/obj/machinery/door/airlock/diamond
	name = "Diamond Airlock"
	icon = 'icons/obj/doors/Doordiamond.dmi'
	matter = /decl/material/solid/gemstone/diamond

/obj/machinery/door/airlock/uranium
	name = "Uranium Airlock"
	desc = "And they said I was crazy."
	icon = 'icons/obj/doors/Dooruranium.dmi'
	matter = /decl/material/solid/metal/uranium
	var/last_event = 0
...
/obj/machinery/door/airlock/uranium/Initialize()
	..()
	var/datum/radiation_source/S = new(src, 15, TRUE)
	S.range = 3
	SSradiation.add_source(S) // Values taken from the radiate proc below
