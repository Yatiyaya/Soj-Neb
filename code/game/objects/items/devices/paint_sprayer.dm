...
/obj/item/paint_sprayer
	...
	var/list/decals = list(
		"Quarter-turf" =      list("path" = /obj/effect/floor_decal/corner/white, "precise" = 1, "colored" = 1),
		"Monotile full" =     list("path" = /obj/effect/floor_decal/corner/white/full, "colored" = 1),
		"Monotile halved" =   list("path" = /obj/effect/floor_decal/corner/white/diagonal, "colored" = 1),
		...
		"1" =                 list("path" = /obj/effect/floor_decal/sign/a),
